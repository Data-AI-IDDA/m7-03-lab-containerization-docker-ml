...
# Liveness probe — re-verify the model still loads. Same command as CMD for a
# verifier container; a real serving container would curl a /health endpoint.
